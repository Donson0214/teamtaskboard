...
const restBoardsRouter = require("./modules/rest/boards.router");
const restColumnsRouter = require("./modules/rest/columns.router");
const restTasksRouter = require("./modules/rest/tasks.router");
const restCommentsRouter = require("./modules/rest/comments.router");
const restAttachmentsRouter = require("./modules/rest/attachments.router");
const restMembersRouter = require("./modules/rest/members.router");
...
app.use("/api/boards", requireAuth, restBoardsRouter);
app.use("/api/columns", requireAuth, restColumnsRouter);
app.use("/api/tasks", requireAuth, restTasksRouter);
app.use("/api/comments", requireAuth, restCommentsRouter);
app.use("/api/attachments", requireAuth, restAttachmentsRouter);
app.use("/api/members", requireAuth, restMembersRouter);
