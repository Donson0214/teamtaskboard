      ...
      >
        ...
        <div class="max-h-[70vh] overflow-y-auto p-6 md:p-8 space-y-6">
          ...
          <div class="space-y-5">
            ...
            <div :class="sectionCard" class="p-4 md:p-5">
              <div class="flex items-center justify-between mb-3">
                <label class="text-sm font-semibold" :class="mutedText">Labels</label>
                <span v-if="readonly" class="text-[11px]" :class="mutedText">View only</span>
              </div>
              <div class="flex flex-wrap gap-2">
                <button
                ...
                <p v-if="!labels?.length" class="text-xs" :class="mutedText">
                  No labels yet.
                </p>
              </div>
            </div>
