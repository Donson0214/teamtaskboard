<template>
  <div class="workspace-view min-h-screen relative overflow-hidden pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]" :class="isDark ? 'bg-slate-950' : 'bg-slate-50'">
    ...
    >
      <div class="px-4 py-6 sm:px-6 flex items-center justify-end">
    ...
    >
      ...
      <main class="flex-1 p-4 sm:p-6 relative">
            ...
            <div class="space-y-6">
              <div class="flex items-center justify-between flex-wrap gap-3">
                ...
                <div class="flex gap-2">
                  ...
                  >
                    <AppIcon icon="fa-plus" class="text-xs mr-2" /> New
                  </button>
                 
                </div>
              </div>

              <div class="rounded-2xl border relative" :class="isDark ? 'bg-slate-900/70 border-slate-800' : 'bg-white border-slate-200 shadow-sm'">
                <div
                  v-if="isLoading"
                ...
                <div class="flex items-center justify-between gap-3 p-4">
                  <div class="flex items-center gap-2">
                    <AppIcon :icon="primarySectionIcon" class="text-slate-500" />
                    ...
                    >
                      ...
                      <div class="p-4 space-y-3">
                        ...
                        <div class="flex items-center justify-between text-xs" :class="isDark ? 'text-slate-400' : 'text-slate-600'">
                          ...
                          <div class="flex items-center gap-2">
                            <AppIcon icon="fa-calendar" class="text-[11px]" />
              ...
              <div v-if="showCollaborationSection" class="space-y-3">
                <div class="flex items-center gap-2">
                  <AppIcon icon="fa-handshake" class="text-slate-500" />
            ...
            <aside class="space-y-4">
              <div class="rounded-2xl border p-4" :class="isDark ? 'bg-slate-900/70 border-slate-800' : 'bg-white border-slate-200 shadow-sm'">
                <div class="flex items-center gap-2 mb-3">
                  <AppIcon icon="fa-chart-bar" class="text-slate-500" />
...
const MemberManagementModal = defineAsyncComponent(() =>
  import("@/features/workspaces/modals/MemberManagementModal.vue")
);
...
const handleNavClick = async (item) => {
  ...
  if (item.id === "tasks") {
    ...
    if (!hasBoardCache) {
      try {
        await withLoading(() => workspaceStore.loadBoards(targetId));
